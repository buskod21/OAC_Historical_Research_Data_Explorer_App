...
> The RED‑X app uses renv to isolate and restore R package versions. This ensures that collaborators and users can reproduce the environment consistently across systems.
