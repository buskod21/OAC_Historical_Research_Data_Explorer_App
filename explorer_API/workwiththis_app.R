...
server <- function(input, output, session) {
  ...
  # Reactive expression for fetching all_data() in OAC dataverses
  all_data <- reactive ({
  ...
  # Reactive expression for fetching detailed_data() based on selected dataverse
  ...
  # Reactive expression for extracting and processing detailed_data() keywords used in the network plot
  keywords <- reactive({
  ...
  # Reactive expression for extracting and processing detailed_data() authors used in the network plot
  authors <- reactive({
  ...
  # Reactive expression to prepare network data (i.e., nodes and edges) using the processed keywords() and authors()
  # Only detailed_data() is needed for the network plot
  # Note: All_data() and detailed_data() contains same information
  # Except detailed_data is depends on user input i.e., selection of dataverse to populate which is required for the network plot
  ...
  # When an event is selected in the network i.e., keyword or author, update the study select input
